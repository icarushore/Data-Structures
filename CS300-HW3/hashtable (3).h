...
void HashTable<Key, Value>::insert(const Key &x, const Value &v)
{
    ...
    //cout << array[currentPos].word << endl;
    ++currentSize;
}
/**
...
void HashTable<Key, Value>::rehash()
{
    ...
    cout << "current unique word count " << currentSize << ", current load factor: " << static_cast<double>(currentSize) / array.size()<< endl;
...
void HashTable<Key,Value>:: printPreprocess(){
    cout << "After preprocessing, the unique word count is " << currentSize << ". Current load ratio is: " << static_cast<double>(currentSize) / array.size() << endl;
}
#endif